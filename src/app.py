...
)  # force to load css in this order
                    ...
                    dbc.Col(
                        html.Div(
                            [
                                ...
                                html.P(
                                    "Welcome to Team 16's website! In this page, you will find various data visualizations and information on tweets related to the EUR/USD currency pair.",
                                    style={
                                        "font-size": "18",
                                        "margin-bottom": "10px",
                                        "margin-left": "25px",
                                                ...
                                                [
                                                    ...
                                                    dbc.Row(
                                                            ...
                                                            dbc.Col(
                                                                [
                                                                    ...
                                                                    html.Div(
                                                                        [
                                                                            html.P(
                                                                                "This first visualisation shows the values of the EURUSD and the activity index over the selected time period."
                                                                            ),
                                                                            html.P(
                                                                                "The price line is green when both the variations of the price and the index go in the same direction, it is red otherwise.\
                                                        ...
                                                        The influential tweets displayed in the box are the 3 tweets with the greatest audience (number of followers) posted on the day before the high index variation."
                                                                            ...
                                                                            html.Div(
                                                                                className="bandeau_dessous",
                                                                                children=[
                                                                                    html.Div(
                                                                                        className="selecteur_viz",
                                                                                        children=[
                                                                                            None
                                                                                        ],
                                                                                    ),
                                                                            ...
                                                                            dbc.Row(
                                                                                className="main_vis_container",
                                                                                children=[
                                                                                    dbc.Col(
                                                                                        [
                                                                                            dcc.Graph(
                                                                                                id="main_vis",
                                                                                                figure=main_viz.init_main_figure(
                                                                                                    preprocess.select_timeframe(
                                                                                                        stats,
                                                                                                        start,
                                                                                                        display,
                                                                                                    )
                                                            ...
                                                            dbc.Col(
                                                                [
                                                                    ...
                                                                    html.Div(
                                                                        [
                                                                            html.P(
                                                                                "This spider chart shows the hourly index variations starting from March 2021 to August 2021. As we can see, the variation seems to peak at 2 PM EST on average. Switch over to the 'Scatter' tab to see more detailed entries."
                                                                            ),
                                                                            html.Div(
                                                                                className="radar_vis",
                                                                                children=[
                                                                                    html.Div(
                                                                                        [
                                                                                            dcc.Graph(
                                                                                                id="radar_vis",
                                                                                                figure=radar.init_radar_figure(
                                                                                                    preprocess.select_timeframe(
                                                                                                        stats,
                                                                                                        start,
                                                                                                        display,
                                                            ...
                                                            dbc.Col(
                                                                [
                                                                    ...
                                                                    html.Div(
                                                                        [
                                                                            html.P(
                                                                                "That's it for now! Stay tuned for more information on currency exchange rates."
                                                                            ),
                                                                        ],
                                                                        style=graph_box_style,
                                                                    ),
...
@app.callback(
    ...
    [Input("main_vis", "clickData"), Input("search-input", "value")],
    [
...
def display_tweet(click, query, cur_tweet, cur_index, cur_date):
    ...
    if not ctx.triggered:
        return (
            ...
            [],
            [
                "Click on a dark marker on the index chart to see more information about the tweet that led to high index variation."
            ],
        )
    ...
    if ctx.triggered[0]["prop_id"] == "search-input.value":
        ...
        output1 = html.Div(
            [
                html.P(tweet[i], style={"margin-top": "0px", "padding-top": "0px"})
    ...
    elif (ctx.triggered[0]["prop_id"].split(".")[0] == "main_vis") & (
        ctx.triggered[0]["value"]["points"][0]["curveNumber"] == 0
    ):
        ...
        output1 = html.Div(
            [
                html.Div(
                    [
                        html.P(
                            tweet[i], style={"margin-top": "0px", "padding-top": "0px"}
                        )
                        for i in range(len(tweet))
                    ]
                )
        ...
        index_variation = (
            stats[stats["timestamp"] == date]["index_variation"].round(2).values[0]
        )
...
@app.callback(
    Output("datepicker_button", "is_open"), [Input("auto-toast-toggle", "n_clicks")]
)
def open_toast(n):
    if n == 0:
        return no_update
