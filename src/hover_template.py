def get_radar_trend_hover_template():
    ...
    """
    return (
        '<span style="font-weight:bold;">Time :</b> %{theta}:00 <br></span>'
...
def get_bar_chart_hover_template():
    ...
    """
    return (
        '<span style="font-weight:bold;">Number of tweets :</b> %{y} </span>'
...
def get_main_vis_line_chart_hover_template():
    ...
    """
    return (
        '<span style="font-weight:bold;">Date & Time :</b> %{x} <br></span>'
